...
from xmodule.graders import ProblemScore, AggregatedScore, aggregate_scores, ShowCorrectness
...
class ShowCorrectnessTest(unittest.TestCase):
    ...
    def test_show_correctness_always(self, show_correctness, has_staff_access):
        ...
        """
        self.assertTrue(ShowCorrectness.correctness_available(show_correctness=show_correctness,
